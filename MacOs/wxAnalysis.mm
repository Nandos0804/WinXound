...
- (void)SetDefaultValues:(NSString *)mUtilityName {
    ...
    case 0: //"ATSA":
        ...
        [wxDefaults setValue:[NSNumber numberWithInt:1]
                      forKey:@"w_Atsa"]; //[w_Atsa selectItemAtIndex:1];
                                         ////Selected index
        [wxDefaults setValue:[NSNumber numberWithInt:3]
                      forKey:@"F_File_Atsa"]; //[F_File_Atsa selectItemAtIndex:
                                              //3]; //Selected index
    ...
    case 2:                                                 //"HETRO":
        ...
        [wxDefaults setValue:@"32767" forKey:@"Max_Hetro"]; // Max_Hetro =
                                                            // 32767;
        ...
        [wxDefaults setValue:[NSNumber numberWithBool:false]
                      forKey:@"SDIF_Hetro"];
        break;
    ...
    case 3:                                                //"LPANAL":
        ...
        [wxDefaults setValue:[NSNumber numberWithInt:0]
                      forKey:@"v_Lpanal"]; //[v_Lpanal selectItemAtIndex:0];
                                           ////SelectedIndex
        [wxDefaults setValue:[NSNumber numberWithBool:false]
                      forKey:@"a_Lpanal"]; //[a_Lpanal setState:NSOnState];
        [wxDefaults setValue:@""
                      forKey:@"Comments_Lpanal"]; // Comments_Lpanal = @"";
        break;
    ...
    case 4:                                                //"PVANAL":
        ...
        [wxDefaults setValue:[NSNumber numberWithInt:7]
                      forKey:@"n_Pvanal"]; //[n_Pvanal selectItemAtIndex:7]; //
                                           //7 = 2048;
        [wxDefaults setValue:[NSNumber numberWithInt:0]
                      forKey:@"w_Pvanal"]; //[w_Pvanal selectItemAtIndex:0];
        [wxDefaults
            setValue:[NSNumber numberWithInt:3]
              forKey:@"h_Pvanal"]; //[h_Pvanal selectItemAtIndex:3];//3 = 128;
        [wxDefaults
            setValue:[NSNumber numberWithInt:1]
              forKey:@"window_Pvanal"]; //[window_Pvanal selectItemAtIndex:1];
                                        //// 1 = Von Hann;
        [wxDefaults setValue:[NSNumber numberWithBool:false]
                      forKey:@"PvocExFile_Pvanal"];
        break;
    }
...
- (NSString *)ATSA {
    ...
    if ([[wxDefaults valueForKey:@"b_Atsa"] doubleValue] >
        0) // if (b_Atsa.Value > 0)
    {
        // tFlags += "-b" + b_Atsa.Value + " ";
        [tFlags appendString:[NSString
                                 stringWithFormat:@"-b%@ ",
                                                  [wxDefaults
                                                      valueForKey:@"b_Atsa"]]];
    }
    if ([[wxDefaults valueForKey:@"e_Atsa"] doubleValue] >
        0) // if (e_Atsa.Value > 0)
    {
    ...
    if ([[wxDefaults valueForKey:@"l_Atsa"] integerValue] !=
        20) // if (l_Atsa.Value != 20)
    {
    ...
    if ([[wxDefaults valueForKey:@"Max_Atsa"] integerValue] !=
        20000) // if (Max_Atsa.Value != 20000)
    {
        ...
        [tFlags
            appendString:[NSString
                             stringWithFormat:@"-H%@ ",
                                              [wxDefaults
                                                  valueForKey:@"Max_Atsa"]]];
    }
    if ([[wxDefaults valueForKey:@"d_Atsa"] doubleValue] !=
        0.1) // if ((double)d_Atsa.Value != 0.1)
    {
    ...
    if ([[wxDefaults valueForKey:@"c_Atsa"] integerValue] !=
        4) // if (c_Atsa.Value != 4)
    {
    ...
    if ([[wxDefaults valueForKey:@"w_Atsa"] integerValue] !=
        1) // if (w_Atsa.SelectedIndex != 1)
    {
    ...
    if ([[wxDefaults valueForKey:@"h_Atsa"] doubleValue] !=
        0.25) // if ((double)h_Atsa.Value != 0.25)
    {
    ...
    if ([[wxDefaults valueForKey:@"m_Atsa"] doubleValue] !=
        -60) // if (m_Atsa.Value != -60)
    {
    ...
    if ([[wxDefaults valueForKey:@"t_Atsa"] integerValue] !=
        3) // if (t_Atsa.Value != 3)
    {
    ...
    if ([[wxDefaults valueForKey:@"s_Atsa"] integerValue] !=
        3) // if (s_Atsa.Value != 3)
    {
    ...
    if ([[wxDefaults valueForKey:@"g_Atsa"] integerValue] !=
        3) // if (g_Atsa.Value != 3)
    {
    ...
    if ([[wxDefaults valueForKey:@"T_SMR_Atsa"] doubleValue] !=
        30) // if (T_SMR_Atsa.Value != 30)
    {
        ...
        [tFlags
            appendString:[NSString
                             stringWithFormat:@"-T%@ ",
                                              [wxDefaults
                                                  valueForKey:@"T_SMR_Atsa"]]];
    }
    if ([[wxDefaults valueForKey:@"S_SMR_Atsa"] doubleValue] !=
        60) // if (S_SMR_Atsa.Value != 60)
    {
        ...
        [tFlags
            appendString:[NSString
                             stringWithFormat:@"-S%@ ",
                                              [wxDefaults
                                                  valueForKey:@"S_SMR_Atsa"]]];
    }
    if ([[wxDefaults valueForKey:@"P_Peak_Atsa"] doubleValue] >
        0) // if (P_Peak_Atsa.Value > 0)
    {
        ...
        [tFlags
            appendString:[NSString
                             stringWithFormat:@"-P%@ ",
                                              [wxDefaults
                                                  valueForKey:@"P_Peak_Atsa"]]];
    }
    if ([[wxDefaults valueForKey:@"M_SMR_Atsa"] doubleValue] !=
        0.5) // if ((double)M_SMR_Atsa.Value != 0.5)
    {
        ...
        [tFlags
            appendString:[NSString
                             stringWithFormat:@"-M%@ ",
                                              [wxDefaults
                                                  valueForKey:@"M_SMR_Atsa"]]];
    }
    if ([[wxDefaults valueForKey:@"F_File_Atsa"] integerValue] !=
        3) // if (F_File_Atsa.SelectedIndex != 3)
    {
        // tFlags += "-F" + F_File_Atsa.SelectedIndex + 1 + " ";
        [tFlags
            appendString:[NSString
                             stringWithFormat:@"-F%d ",
                                              [[wxDefaults
                                                  valueForKey:@"F_File_Atsa"]
                                                  integerValue] +
                                                  1]];
    }

    NSString *result =
        [tFlags stringByTrimmingCharactersInSet:[NSCharacterSet
...
- (NSString *)CVANAL {
    ...
    if ([[wxDefaults valueForKey:@"s_Cvanal"] integerValue] >
        10000) // if (s_Cvanal.Value != 10000)
    {
        ...
        [tFlags
            appendString:[NSString
                             stringWithFormat:@"-s%@ ",
                                              [wxDefaults
                                                  valueForKey:@"s_Cvanal"]]];
    }
    if ([[wxDefaults valueForKey:@"c_Cvanal"] integerValue] >
        0) // if (c_Cvanal.Value > 0)
    {
        ...
        [tFlags
            appendString:[NSString
                             stringWithFormat:@"-c%@ ",
                                              [wxDefaults
                                                  valueForKey:@"c_Cvanal"]]];
    }
    if ([[wxDefaults valueForKey:@"b_Cvanal"] doubleValue] >
        0) // if (b_Cvanal.Value > 0)
    {
        ...
        [tFlags
            appendString:[NSString
                             stringWithFormat:@"-b%@ ",
                                              [wxDefaults
                                                  valueForKey:@"b_Cvanal"]]];
    }
    if ([[wxDefaults valueForKey:@"d_Cvanal"] doubleValue] >
        0) // if (d_Cvanal.Value > 0)
    {
...
- (NSString *)HETRO {
    ...
    if ([[wxDefaults valueForKey:@"s_Hetro"] integerValue] !=
        10000) // if (s_Hetro.Value != 10000)
    {
    ...
    if ([[wxDefaults valueForKey:@"c_Hetro"] integerValue] !=
        1) // if (c_Hetro.Value != 1)
    {
    ...
    if ([[wxDefaults valueForKey:@"b_Hetro"] doubleValue] >
        0) // if (b_Hetro.Value > 0)
    {
    ...
    if ([[wxDefaults valueForKey:@"d_Hetro"] doubleValue] >
        0) // if (d_Hetro.Value > 0)
    {
    ...
    if ([[wxDefaults valueForKey:@"f_Hetro"] integerValue] !=
        100) // if (f_Hetro.Value != 100)
    {
    ...
    if ([[wxDefaults valueForKey:@"h_Hetro"] integerValue] !=
        10) // if (h_Hetro.Value != 10)
    {
    ...
    if ([[wxDefaults valueForKey:@"Max_Hetro"] integerValue] !=
        32767) // if (Max_Hetro.Value != 32767)
    {
        ...
        [tFlags
            appendString:[NSString
                             stringWithFormat:@"-M%@ ",
                                              [wxDefaults
                                                  valueForKey:@"Max_Hetro"]]];
    }
    if ([[wxDefaults valueForKey:@"min_Hetro"] integerValue] !=
        64) // if (min_Hetro.Value != 64)
    {
        ...
        [tFlags
            appendString:[NSString
                             stringWithFormat:@"-m%@ ",
                                              [wxDefaults
                                                  valueForKey:@"min_Hetro"]]];
    }
    if ([[wxDefaults valueForKey:@"n_Hetro"] integerValue] !=
        256) // if (n_Hetro.Value != 256)
    {
    ...
    if ([[wxDefaults valueForKey:@"l_Hetro"] integerValue] >
        0) // if (l_Hetro.Value > 0)
    {
...
- (NSString *)LPANAL {
    ...
    if ([[wxDefaults valueForKey:@"s_Lpanal"] integerValue] !=
        10000) // if (s_Lpanal.Value != 10000)
    {
        ...
        [tFlags
            appendString:[NSString
                             stringWithFormat:@"-s%@ ",
                                              [wxDefaults
                                                  valueForKey:@"s_Lpanal"]]];
    }
    if ([[wxDefaults valueForKey:@"c_Lpanal"] integerValue] !=
        1) // if (c_Lpanal.Value != 1)
    {
        ...
        [tFlags
            appendString:[NSString
                             stringWithFormat:@"-c%@ ",
                                              [wxDefaults
                                                  valueForKey:@"c_Lpanal"]]];
    }
    if ([[wxDefaults valueForKey:@"b_Lpanal"] doubleValue] >
        0) // if (b_Lpanal.Value > 0)
    {
        ...
        [tFlags
            appendString:[NSString
                             stringWithFormat:@"-b%@ ",
                                              [wxDefaults
                                                  valueForKey:@"b_Lpanal"]]];
    }
    if ([[wxDefaults valueForKey:@"d_Lpanal"] doubleValue] >
        0) // if (d_Lpanal.Value > 0)
    {
        ...
        [tFlags
            appendString:[NSString
                             stringWithFormat:@"-d%@ ",
                                              [wxDefaults
                                                  valueForKey:@"d_Lpanal"]]];
    }

    if ([[wxDefaults valueForKey:@"p_Lpanal"] integerValue] !=
        34) // if (p_Lpanal.Value != 34)
    {
        ...
        [tFlags
            appendString:[NSString
                             stringWithFormat:@"-p%@ ",
                                              [wxDefaults
                                                  valueForKey:@"p_Lpanal"]]];
    }
    if ([[wxDefaults valueForKey:@"h_Lpanal"] integerValue] !=
        200) // if (h_Lpanal.Value != 200)
    {
        ...
        [tFlags
            appendString:[NSString
                             stringWithFormat:@"-h%@ ",
                                              [wxDefaults
                                                  valueForKey:@"h_Lpanal"]]];
    }
    if ([[wxDefaults valueForKey:@"Max_Lpanal"] integerValue] !=
        200) // if (Max_Lpanal.Value != 200)
    {
        ...
        [tFlags
            appendString:[NSString
                             stringWithFormat:@"-Q%@ ",
                                              [wxDefaults
                                                  valueForKey:@"Max_Lpanal"]]];
    }
    if ([[wxDefaults valueForKey:@"Min_Lpanal"] integerValue] !=
        70) // if (Min_Lpanal.Value != 70)
    {
        ...
        [tFlags
            appendString:[NSString
                             stringWithFormat:@"-P%@ ",
                                              [wxDefaults
                                                  valueForKey:@"Min_Lpanal"]]];
    }
    if ([[wxDefaults valueForKey:@"a_Lpanal"] integerValue] >
        0) // if (a_Lpanal.Checked)
    {
        // tFlags += "-a ";
        [tFlags appendString:@"-a "];
    }
    if ([[wxDefaults valueForKey:@"v_Lpanal"] integerValue] >
        0) // if (!v_Lpanal.Text.Contains("none"))
    {
        ...
        [tFlags
            appendString:[NSString
                             stringWithFormat:@"-v%@ ",
                                              [wxDefaults
                                                  valueForKey:@"v_Lpanal"]]];
    }
    if ([[wxDefaults valueForKey:@"Comments_Lpanal"] length] >
        0) // if (Comments_Lpanal.Text.Length > 0)
    {
        ...
        [tFlags
            appendString:[NSString
                             stringWithFormat:
                                 @"-C%@ ",
                                 [wxDefaults valueForKey:@"Comments_Lpanal"]]];
    }
...
- (NSString *)PVANAL {
    ...
    if ([[wxDefaults valueForKey:@"s_Pvanal"] integerValue] !=
        10000) // if (s_Pvanal.Value != 10000)
    {
        ...
        [tFlags
            appendString:[NSString
                             stringWithFormat:@"-s%@ ",
                                              [wxDefaults
                                                  valueForKey:@"s_Pvanal"]]];
    }
    if ([[wxDefaults valueForKey:@"c_Pvanal"] integerValue] !=
        1) // if (c_Pvanal.Value != 1)
    {
        ...
        [tFlags
            appendString:[NSString
                             stringWithFormat:@"-c%@ ",
                                              [wxDefaults
                                                  valueForKey:@"c_Pvanal"]]];
    }
    if ([[wxDefaults valueForKey:@"b_Pvanal"] doubleValue] >
        0) // if (b_Pvanal.Value > 0)
    {
        ...
        [tFlags
            appendString:[NSString
                             stringWithFormat:@"-b%@ ",
                                              [wxDefaults
                                                  valueForKey:@"b_Pvanal"]]];
    }
    if ([[wxDefaults valueForKey:@"d_Pvanal"] doubleValue] >
        0) // if (d_Pvanal.Value > 0)
    {
...
- (IBAction)wxAnalysisButtonResetClick:(id)sender {
    ...
    if ([[[tabView selectedTabViewItem] label] isEqualToString:@"Atsa"]) {
        [self SetDefaultValues:@"ATSA"];
        // NSLog(@"Reset ATSA");
    } else if ([[[tabView selectedTabViewItem] label]
                   isEqualToString:@"Cvanal"]) {
        [self SetDefaultValues:@"CVANAL"];
        // NSLog(@"Reset CVANAL");
    } else if ([[[tabView selectedTabViewItem] label]
                   isEqualToString:@"Hetro"]) {
        [self SetDefaultValues:@"HETRO"];
        // NSLog(@"Reset HETRO");
    } else if ([[[tabView selectedTabViewItem] label]
                   isEqualToString:@"Lpanal"]) {
        [self SetDefaultValues:@"LPANAL"];
        // NSLog(@"Reset LPANAL");
    } else if ([[[tabView selectedTabViewItem] label]
                   isEqualToString:@"Pvanal"]) {
        [self SetDefaultValues:@"PVANAL"];
        // NSLog(@"Reset PVANAL");
    }
}
...
- (IBAction)wxAnalysisStopClick:(id)sender {
    @try {
        ...
        NSLog(@"wxAnalysis -> wxAnalysisStopClick Error: %@ - %@", [e name],
              [e reason]);
    }
}
...
- (IBAction)wxAnalysisButtonInputClick:(id)sender {
    ...
    [openPanel beginSheetForDirectory:nil
                                 file:nil
                                types:[NSArray arrayWithObjects:@"wav", @"aiff",
                                                                @"aif", nil]
    ...
    @try {
        if (returnCode == NSOKButton) {
            ...
            if ([info isEqualToString:@"INPUT"]) {
                // NSComboBox* comboInput = [self getInputComboBox:[info
                // integerValue]]; NSTextField* textOutput = [self
                // getOutputTextField:[info integerValue] + 10];
                if (comboInput == nil || textOutput == nil)
                    return;

                // Notify user that there are other files into the list
                // if (input.Items.Count > 0)
                if ([comboInput numberOfItems] > 0) {
                    NSInteger ret = [wxMAIN
                            ShowMessage:@"Input Files List Alert:"
                        informativeText:
                            @"There are one or more files in the input list.\n"
                             "Do you want to keep them (the new files will be "
                             "added)?"
                          defaultButton:@"YES"
                        alternateButton:@"NO"
                            otherButton:@"Cancel"];
                ...
                if ([[textOutput stringValue] length] == 0) {
                    NSString *path = [[comboInput itemObjectValueAtIndex:0]
...
- (void)StartCompiler // string arguments)
{
    if ([[comboInput stringValue] length] == 0) {
        [wxMAIN ShowMessage:@"Input file not specified!"
            informativeText:@"Please specify a valid input file before to "
                            @"start CSound analysis."
              defaultButton:@"OK"
            alternateButton:nil
                otherButton:nil];
        return;
    ...
    if ([[textOutput stringValue] length] == 0) {
        [wxMAIN ShowMessage:@"Output path not specified!"
            informativeText:@"Please specify a valid output path before to "
                            @"start CSound analysis."
              defaultButton:@"OK"
            alternateButton:nil
                otherButton:nil];
    ...
    // csound -+msg_color=false -U atsa   "/Users/teto/Desktop/File
    // CSD/fm_01.wav" "/Users/teto/Desktop/File CSD/fm_01.ats"

    // if([comboInput isEnabled])
    [comboInput selectItemAtIndex:mCurrentIndex];

    NSString *flags = @"";
    NSMutableString *filename1 =
        [NSMutableString stringWithString:[comboInput stringValue]];
    NSMutableString *filename2 = [NSMutableString stringWithString:@""];

    NSMutableString *arguments = [NSMutableString
        stringWithFormat:@"-U%@ ", [[[tabView selectedTabViewItem] label]
                                       lowercaseString]];
    ...
    [arguments appendString:[NSString stringWithFormat:@"%@ ", flags]];
    ...
    if ([[textOutput stringValue] length] > 0 && isSndinfo == false) {
        ...
        if ([[[tabView selectedTabViewItem] label] isEqualToString:@"Pvanal"]) {
            if ([[wxDefaults valueForKey:@"PvocExFile_Pvanal"] integerValue] >
                0) // Extended format (pvoc-ex)
                [o appendString:@".pvx"];
            else
                [o appendString:@".pv"]; // Simple format

        } else if ([[[tabView selectedTabViewItem] label]
                       isEqualToString:@"Hetro"] && // Sdif extension
                   [[wxDefaults valueForKey:@"SDIF_Hetro"] integerValue] > 0) {
            [o appendString:@".sdif"];
        } else {
            [o appendString:[NSString
                                stringWithFormat:@".%@",
                                                 [[[[tabView
                                                     selectedTabViewItem] label]
                                                     lowercaseString]
                                                     substringToIndex:3]]];
        }
    ...
    NSString *finalArguments =
        [arguments stringByTrimmingCharactersInSet:[NSCharacterSet
                                                       whitespaceCharacterSet]];
    ...
    if ([comboInput numberOfItems] > 1) {
        ...
        [compilerHost
            setTitle:[NSString
                         stringWithFormat:@"Batch processing: %@ [%d of %d]",
                                          filename2, //[comboInput stringValue],
                                          mCurrentIndex + 1,
                                          [comboInput numberOfItems]]];
    } else {
        [compilerHost
            setTitle:[NSString stringWithFormat:@"Compiler output: %@",
                                                // finalArguments,
                                                filename2]];
    }
    ...
    if (mCurrentIndex < 1 ||
        [[compilerOutputAnalysis string] length] >= NSIntegerMax)
        [compilerOutputAnalysis setString:@""];
    // else we must append two LF
    else
        [[[compilerOutputAnalysis textStorage] mutableString]
            appendString:@"\n\n"];
...
- (void)compilerCompleted {
    ...
    if (mCurrentIndex < [comboInput numberOfItems] && mStopBatch == false) {
        ...
        [compilerHost
            setTitle:[NSString stringWithFormat:@"%@ - COMPLETED",
                                                [compilerHost title]]];
