    ...
    [mainWindow
        setBackgroundColor:
            [NSColor colorWithPatternImage:
                         [NSImage imageNamed:@"FormAboutBackgroundImage.jpg"]]];
...
//     alloc] initWithString: inString]; NSRange range = NSMakeRange(0,
//     [attrString length]);
//
...
//     [attrString addAttribute:NSForegroundColorAttributeName value:[NSColor
//     blueColor] range:range];
//
//     // next make the text appear with an underline
//     [attrString addAttribute:
//	 NSUnderlineStyleAttributeName value:[NSNumber
//numberWithInt:NSSingleUnderlineStyle] range:range];
//
