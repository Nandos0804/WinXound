...
class wxBrowser {
  public:
    ...
    type_signal_csound_file_clicked signal_csound_file_clicked() {
        return m_signal_csound_file_clicked;
    };
  ...
  protected:
    ...
    static void on_check_resize_browser(GtkWidget *widget, GtkAllocation *allocation,
                                        gpointer data);
    void check_resize();
