...
class wxSettings {
  ...
  public:
    ...
    void LookForBinaries(Glib::ustring &entryCSoundExecutable, Glib::ustring &entryCSoundHelp,
                         Glib::ustring &entryCSoundExternalGUI, Glib::ustring &entryPythonCompiler,
                         Glib::ustring &entryPythonExternalGUI, Glib::ustring &entryLuaCompiler,
                         Glib::ustring &entryLuaExternalGUI, Glib::ustring &entryWavePlayer,
                         Glib::ustring &entryWaveEditor, Glib::ustring &entryCalculator);
