...
class wxTextEditor : public Gtk::Frame // public Gtk::VPaned
{
  public:
    ...
    gint FindText(const gchar *text, bool MatchWholeWord, bool MatchCase, bool IsBackward,
                  bool SelectText, bool ShowMessage, bool SkipRem);
    gint FindText(const gchar *text, bool MatchWholeWord, bool MatchCase, bool IsBackward,
                  bool SelectText, bool ShowMessage, bool SkipRem, gint Start, gint End);
    gint FindText(const gchar *text, bool MatchWholeWord, bool MatchCase, bool IsBackward,
                  bool SelectText, bool ShowMessage, bool SkipRem, gint start, gint end,
                  bool useRegEx);
    ...
    gint ReplaceAllText(const gchar *StringToFind, const gchar *ReplaceString, bool MatchWholeWord,
                        bool MatchCase, bool FromCaretPosition, bool FCPUp);
