...
class wxFindCodeStructure {
  ...
  protected:
    ...
    bool findString(const gchar *stringToFind, Gtk::TreeModel::Row passedNode, bool isScore);
    bool findStringInScore(const gchar *stringToFind, Gtk::TreeModel::Row passedNode);
