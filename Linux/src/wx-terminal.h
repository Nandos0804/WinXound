...
class wxTerminal //: public Gtk::Box
{
  public:
    ...
    void Compile(Glib::ustring compilerName, Glib::ustring parameters, Glib::ustring filename1,
                 Glib::ustring filename2);
    void Compile(Glib::ustring compilerName, Glib::ustring parameters, Glib::ustring filename1,
                 Glib::ustring filename2, bool ClearBuffer);
  ...
  protected:
    ...
    static void on_check_resize(GtkWidget *widget, GtkAllocation *allocation, gpointer user_data);
    void check_resize();
