...
class wxEditor : public Gtk::HPaned {
  public:
    ...
    type_signal_save_point_reached signal_save_point_reached() {
        return m_signal_save_point_reached;
    };
    ...
    typedef sigc::signal<void, wxEditor *, GdkEventKey *, const gchar *>
        type_signal_autocompletion_synopsis;
    type_signal_autocompletion_synopsis signal_autocompletion_synopsis() {
        return m_signal_autocompletion_synopsis;
    };
