...
class wxMain : public Gtk::Window {
  public:
    ...
    bool on_labels_drag_motion(const Glib::RefPtr<Gdk::DragContext> &context, int x, int y,
                               guint time);
    ...
    bool FindNext(const gchar *text, bool MatchWholeWord, bool MatchCase);
    bool FindPrevious(const gchar *text, bool MatchWholeWord, bool MatchCase);
    void Replace(const gchar *StringToFind, const gchar *ReplaceString, bool MatchWholeWord,
                 bool MatchCase, bool FromCaretPosition, bool FCPUp, bool ReplaceAll);
  ...
  protected:
    ...
    void on_DragDataReceived(const Glib::RefPtr<Gdk::DragContext> &context, int x, int y,
                             const Gtk::SelectionData &selection_data, guint info, guint time);

    void on_settings_save_Clicked();

    void onSignalAutocompletionSynopsis(wxEditor *editor, GdkEventKey *event, const gchar *opcode);
